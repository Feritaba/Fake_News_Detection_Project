...
time ./doc2vecc -train ./statements/sentences/norm.txt -word wordvectors.txt -output docvectors.txt -cbow 1 -size 256 -window 10 -negative 5 -hs 0 -sample 0 -threads 4 -binary 0 -iter 20 -min-count 10 -test ./statements/sentences/norm.txt -sentence-sample 0.1 -save-vocab alldata.vocab
